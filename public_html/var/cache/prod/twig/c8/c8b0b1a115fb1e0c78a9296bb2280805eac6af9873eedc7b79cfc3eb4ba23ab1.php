    ...
    <form method=\"get\" class=\"searchform\" action=\"";
        ...
        <div class=\"ec-headerSearch__keyword\">
            <div class=\"ec-input\">
                ";
        // line 22
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, ($context["form"] ?? null), "name", [], "any", false, false, false, 22), 'widget', ["id" => null, "attr" => ["class" => "search-name", "placeholder" => "キーワード入力"]]);
        echo "
